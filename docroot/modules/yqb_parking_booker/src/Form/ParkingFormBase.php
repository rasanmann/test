...
// Logic for saving data goes here...
    ...
    protected function generateHeader() {
        ...
        if ($booking) {
            ...
            switch($parkingSlug) {
                case 'p1': $parkingSlug = 'inparq'; break;
                case 'p2': $parkingSlug = 'proxiparq'; break;
            }
    ...
    protected function generateProductResults($products, $arrivalDate, $departureDate, $promoCode = null) {
        ...
        if ($products) {
            foreach ($products as $id => $product) {
                ...
                $locationModal = $this->generateModal('location-' . $carPark->id, $this->t('Localisation sur la carte'), [
                    'map' => [
                        '#type' => 'html_tag',
                        '#tag' => 'img',
                ...
                $informationModal = $this->generateModal('information-' . $carPark->id, $this->t('Information supplémentaire'), [
                    'info' => [
                        '#type' => 'html_tag',
                        '#tag' => 'div',
    ...
    protected function generateBookingOrderConfirmation($booking, $modification = null) {
        ...
        foreach($booking->items as $type => $items) {
            foreach($items as $key => $item) {
                ...
                switch($type) {
                    case 'parkings': $label = $this->t('Stationnement'); break;
                    case 'extras': $label = $this->t('Extra'); break;
                }
