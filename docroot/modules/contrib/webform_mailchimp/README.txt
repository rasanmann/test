...
7. You may add your MailChimp interest groups as predefined options in Webform. This allows you to add fields to your
Webform, such as checkboxes, and use interest groups to populate the values. Then end users are able to select their
desired interest groups on the form and submit them to MailChimp. Interest groups are added as predefined options on
module install, and can also be imported/updated on the Webforms options form at Structure->Webform->Configuration
->Options.
